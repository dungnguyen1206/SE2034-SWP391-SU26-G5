...
-- ============================================================
-- 18. article_comments  [CẬP NHẬT - 15/07]
-- ============================================================
CREATE TABLE article_comments (
    ...
    CONSTRAINT FK_ArticleComment_Article FOREIGN KEY (article_id) REFERENCES articles(id),
    CONSTRAINT FK_ArticleComment_User FOREIGN KEY (user_id) REFERENCES users(id)
);
GO

-- ============================================================
-- 19. email_logs  [Giữ nguyên từ v8.3 - Cập nhật số thứ tự]
-- ============================================================
...
-- ============================================================
-- 20. notifications  [Giữ nguyên từ v8.3 - Cập nhật số thứ tự]
-- ============================================================
