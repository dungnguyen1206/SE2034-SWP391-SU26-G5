...
public class ReceptionistAppointmentController {
    ...
    public String showAppointmentList(
        ...
        Page<AppointmentResponse> appointmentPage = appointmentService.searchAppointmentListForReceptionist(search, status, fromDate, toDate,
                page, size);
    ...
    private void addAppointmentStatusCounts(Model model, LocalDate fromDate, LocalDate toDate) {
        Map<String, Long> statusCounts = appointmentService
                .getAppointmentStatusCountsInDateRangeForReceptionist(fromDate, toDate);
    ...
    private void addReceptionistInfo(Model model, CustomUserDetails userDetails) {
        ...
        String fullName = (user.getLastName() + " " + (user.getMiddleName() != null ? user.getMiddleName() + " " : "")
                + user.getFirstName()).trim().replaceAll("\\s+", " ");
        String avatarText = "";
